...
Picnic Point is a shore dive on the east shore of Possession Sound, on the mainland between Mukilteo and Edmonds. A cobblestone beach gives onto a gently sloping sandy bottom carrying an eelgrass bed, with the slope then dropping away more steeply beyond about 20 m. It is a mild, low-current site with a modest but genuinely varied population for its setting, the kind of place where sea pens and striped nudibranchs turn up on an otherwise plain sand bottom. The one real inconvenience is getting there: a long walk from the parking lot, over a footbridge crossing the railroad tracks, before the beach.
...
| **Type** | Shore, with a walk of roughly 265 m from the parking lot to the beach, across a footbridge over the railroad tracks |
...
* **Depth as a guide.** The bottom is a simple, evenly sloping sand and cobble plain with an eelgrass bed in the shallows and no major structure, so depth tracks distance from shore reliably: shallower is toward the beach, deeper is away from it.
* **Eelgrass line.** The eelgrass bed marks the shallow, subtidal edge of the site, roughly the upper half of the slope. Most of the animals concentrate above it and just below it.
* **The stream mouth.** A small stream runs out of the woods above the park and crosses the beach, a landmark for orienting along the shoreline before entering.
...
Possession Sound swings up to about 5 m between high and low water here, so depths are given against the MLLW chart datum.
...
* **Driven by the season and the bottom.** As elsewhere in the Sound, spring and summer plankton blooms cut visibility back, with winter typically the clearest window. The sand and eelgrass bottom stirs easily underfin, so visibility is usually better on the way in than after divers have worked the shallows.

## Temperature

* **At depth.** Roughly 7 to 14 °C through the year. Standard drysuit protocol.
* **Surface layer.** In late summer the surface warms well above the depth temperature. Dress for the depth, not the walk in.

## Marine life

* **Character.** A modest population for the Sound, but a genuinely varied one for a plain sand and eelgrass site, with sea pens and striped nudibranchs among the more notable finds.
