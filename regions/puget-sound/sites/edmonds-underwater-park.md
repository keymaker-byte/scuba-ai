# Edmonds Underwater Park (Brackett's Landing)

Edmonds Underwater Park is a shore dive on the Puget Sound waterfront at Edmonds, on the beach at Brackett's Landing North, immediately north of the Edmonds to Kingston ferry pier. It is a protected marine sanctuary, also known as the Bruce Higgins Underwater Trails, built up over decades around the sunken DeLion Dry Dock and a scattering of scuttled vessels, all linked by a system of guide ropes, and it is probably the most dived site in the Pacific Northwest. The bottom is shallow, sandy and gently sloping, so the draw is the structure and the dense invertebrate and fish life it holds rather than depth. Its defining hazards are the adjacent ferry lane, a long swim over featureless sand where it is easy to lose the way, and visibility that is often poor.
...
* **Entry.** From the beach at Brackett's Landing North, the sandy cove immediately north of the ferry pier. Cross the beach and enter, then descend at the base of the piling closest to the ferry to pick up the guide rope. On a low tide the exposed beach lengthens the walk to the water considerably.
...
The site is a set of sunken structures on an otherwise featureless sandy bottom, tied together by guide ropes. Working from the entry:

* **Guide rope.** The dive is run along a submerged system of ropes held down by pipes, rocks and yellow road cones, some 4 km of trail in total. It starts at the base of the southern piling, between the shore and the surface rafts, and leads out to the structures and back. Off the rope, navigation over the sand is by compass alone.
* **The dry dock.** The centrepiece is the sunken DeLion Dry Dock, whose two parallel side walls stand about 10 m off the deck, sit about 24 m apart and run about 99 m long, oriented parallel to the ferry slip. A low concrete keel ledge runs down the middle, once a keel support for ships and now a halfway mark for a diver crossing between the walls. The guide rope from the southern piling leads to the northern wall; the second wall lies about 24 m to the south.
* **Surface markers.** The dry dock rests between the ferry slip and the park's surface rafts. In summer, bull kelp attached to the walls floats on the surface over each one and marks their line. At an extreme low tide the tops of the walls are visible from the surface.
* **Other structures.** Several scuttled vessels and smaller enhancements lie north of the dry dock, among them a former tug passed on the way out, all placed away from the dry dock and the ferry slip. The posted map shows their layout and any recent additions.
* **Ending the dive.** Floating on the surface over the site to watch the ferry traffic and the sky is a common and pleasant way to finish, once clear of the ferry lane.
...
|---|---|---|---|
| Top of dry dock walls | about 2 m | about 1 m | about 5 m |
| Dry dock deck and floor | 11 to 12 m | 10 to 11 m | 14 to 15 m |
...
* **Boat traffic and low visibility.** Small-boat traffic works the area, and visibility is often poor, which compounds the ferry and navigation hazards. Fly a marker buoy.
...
* **Character.** The reason the park exists. Sanctuary protection since 1970 and decades of structure on an otherwise bare sandy bottom have concentrated an exceptional density and variety of life, and the animals are used to divers. The dry dock walls and the scuttled vessels are draped in white plumose anemones and tube worms, and the site is a mecca for underwater photographers, by day and, with a permit, by night.
...
* **Anemones and encrusting life.** White plumose anemones cover the dry dock and vessels, with purple and other tube worms, scallops, sea stars, hydromedusae and giant plumose anemones on the vessels' ribs.
