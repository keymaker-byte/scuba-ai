...
A shore dive on the Port Townsend downtown waterfront, built around the wreckage of the town's Victorian past rather than a reef or a wall. The original Union Wharf, built in 1867, once let three tall ships moor at once, and the saloons and brothels that lined it saw generations of bottles, plates and mugs go over the rail into the water below. A smaller wharf now stands in its place, rebuilt in 1998, and a second, abandoned ferry pier with four offshore pylons sits a short swim to the northeast. Divers work the silty bottom between and beyond both structures for period glass and crockery. Animal life is sparse for a Puget Sound shore dive, and the current, while rarely strong, is genuinely unpredictable in direction.
...
* **Adams Street beach.** The hub for both dive areas; the wharf lies southwest, the ferry pier and pylons northeast.
* **Union Wharf.** The rebuilt structure is shorter than the original 1867 wharf, and the water off its end now reads shallower than the old accounts of it.
* **Abandoned ferry pier and pylons.** Northeast of the wharf, in the deeper water toward open water; the four offshore pylons are the far point of the dive.
* **Bottom transition.** Sandy, with patches of eelgrass, from the beach out to about 5 to 6 m below MLLW; beyond that the bottom turns to soft silty mud, where the wharf and pier debris settles.
...
* **Silt driven.** The fine mud beyond about 5 to 6 m stirs easily and is the main limit on visibility, more than depth or current; it clears best right around a slack.
* **Bottle hunting rewards patience.** Close to the pilings and pylons, visibility is usually what limits finding period glass and crockery, not the light or the depth.

## Temperature

* **At depth.** Roughly 7 to 11 C year round, typical for the Sound. Standard drysuit protocol.
* **Surface layer.** Warms into the low teens late in summer, cooler the rest of the year.
