...
A deep, glacially carved lake in Olympic National Park on the Olympic Peninsula, 12 miles long and over 190 m deep at its deepest, filled with water so clear and so low in nutrients that it runs a brilliant, almost tropical blue. There is no current worth mentioning and no tide, so a dive here is a straightforward freshwater shore dive. The headline hazard is exactly that clarity: it lets sunlight reach deep, so a diver used to reading depth off the dimming light can run well past their planned depth before it feels deep at all, and the shore drops fast into water far beyond sport diving limits. Several entry points work around the lake; East Beach, at the eastern end, is the most established.

| | |
|---|---|
| **Location** | Olympic National Park, Clallam County, WA. South shore of Lake Crescent, near the eastern end |
| **Coordinates** | Dive site 48.085275, -123.744945 (East Beach dive area, a short swim out from the beach). No fixed seabed here: the slope keeps dropping well past sport diving limits, so there is no single depth to quote for the point. Entry at 48.085738, -123.743042, the East Beach parking area and beach |
| **Type** | Shore |
...
* **The drop-off.** A narrow shelf a few metres off the beach gives way to a steep slope starting around 6 m.
* **Rock pile.** A boulder garden to the left (west) of the main entry, large house sized rocks stacked down the slope, a shallower alternative to the open slope.
* **The barge.** A sunken wooden barge sits on the slope in the mid twenties of metres, accessible from the main entry line; it has been reported penetrable in places, and silts out fast if fins feather the bottom near it.
* **Other entries.** La Poel day use area, on the south shore roughly midway along the lake, drops onto its own steep slope from a paved pull off, an easy walk in. Sledgehammer Point, on the highway between East Beach and Lake Crescent Lodge, is a sheer wall entry that runs well past 90 m, dived as a technical scooter site, not a recreational one. Devil's Punchbowl, on the north shore off the Spruce Railroad Trail, is reached by a walk of a little over a mile and a short surface swim to a steep walled cove; it draws swimmers as well as divers in summer.
* **Deep wrecks.** Two submerged cars lie well past recreational depth, one near 50 m, one near 58 m, along with an older wreck locals treat as a memorial site rather than something to handle. None of these are sport diving targets; they mark how far the slope keeps going, not a plan.
